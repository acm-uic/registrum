...
COPY ../banner/package.json projects/banner/
COPY ../banner-data/package.json projects/banner-data/
COPY ../api/package.json projects/api/
COPY ../client/package.json projects/client/
COPY ../common/package.json projects/common/
COPY common/ common
COPY rush.json .
